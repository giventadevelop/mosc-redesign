...
const PublicationsSidebar = () => {
  const sidebarLinks = [
    ...
    { label: 'Publications', href: 'http://mosc.in/publications/', icon: 'BookOpen', current: true },
    { label: 'Directory', href: 'http://directory.mosc.in/', icon: 'Users', external: true },
    { label: 'Spiritual Organisations', href: 'http://mosc.in/spiritual/', icon: 'Church' },
  ...
  return (
    <div className="space-y-6">
      <div className="bg-card rounded-lg sacred-shadow p-6">
        ...
        <p className="font-body text-sm text-muted-foreground">Access important resources and information related to the Church.</p>
      </div>
      ...
      <div className="bg-card rounded-lg sacred-shadow p-6">
        <div className="space-y-2">
          {sidebarLinks.map((link, index) => (
            ...
            >
              <Icon name={link.icon} size={16} className={link.current ? 'text-primary' : 'text-muted-foreground'} />
              <span className="flex-1">{link.label}</span>
              {link.external && <Icon name="ExternalLink" size={12} className="text-muted-foreground" />}
            </button>
          ))}
        </div>
      </div>
      ...
      <div className="bg-card rounded-lg sacred-shadow p-6">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h3 className="font-heading font-semibold text-lg text-foreground">About This Page</h3>
        </div>
        <div className="space-y-3">
          <p className="font-body text-sm text-muted-foreground">This section lists publications and archival resources from the MOSC site.</p>
          <div className="pt-3 border-t border-border">
            <p className="font-caption text-xs text-muted-foreground">Keep original assets in <code>/public/publications/</code> for full fidelity.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card rounded-lg sacred-shadow p-6">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h3 className="font-heading font-semibold text-lg text-foreground">Need Help?</h3>
        </div>
        <div className="space-y-3">
          <p className="font-body text-sm text-muted-foreground">For more information or to get involved, contact your local parish or visit the official MOSC website.</p>
          <button
