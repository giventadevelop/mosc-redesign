...
function formatDate(e, r, a) {
    function t(e, r) {
        var a = e + "";
        for (r = r || 2; a.length < r;) a = "0" + a;
        return a
    }
    var g = ["\x00", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
        c = ["", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
        l = ["", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
        p = ["", "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
        n = a ? e.getUTCFullYear() : e.getFullYear();
    r = r.replace(/(^|[^\\])yyyy+/g, "$1" + n), r = r.replace(/(^|[^\\])yy/g, "$1" + n.toString().substr(2, 2)), r = r.replace(/(^|[^\\])y/g, "$1" + n);
    var u = (a ? e.getUTCMonth() : e.getMonth()) + 1;
    r = r.replace(/(^|[^\\])MMMM+/g, "$1" + g[0]), r = r.replace(/(^|[^\\])MMM/g, "$1" + c[0]), r = r.replace(/(^|[^\\])MM/g, "$1" + t(u)), r = r.replace(/(^|[^\\])M/g, "$1" + u);
    var o = a ? e.getUTCDate() : e.getDate();
    r = r.replace(/(^|[^\\])dddd+/g, "$1" + l[0]), r = r.replace(/(^|[^\\])ddd/g, "$1" + p[0]), r = r.replace(/(^|[^\\])dd/g, "$1" + t(o)), r = r.replace(/(^|[^\\])d/g, "$1" + o);
    var M = a ? e.getUTCHours() : e.getHours();
    r = r.replace(/(^|[^\\])HH+/g, "$1" + t(M)), r = r.replace(/(^|[^\\])H/g, "$1" + M);
    var $ = M > 12 ? M - 12 : 0 == M ? 12 : M;
    r = r.replace(/(^|[^\\])hh+/g, "$1" + t($)), r = r.replace(/(^|[^\\])h/g, "$1" + $);
    var d = a ? e.getUTCMinutes() : e.getMinutes();
    r = r.replace(/(^|[^\\])mm+/g, "$1" + t(d)), r = r.replace(/(^|[^\\])m/g, "$1" + d);
    var s = a ? e.getUTCSeconds() : e.getSeconds();
    r = r.replace(/(^|[^\\])ss+/g, "$1" + t(s)), r = r.replace(/(^|[^\\])s/g, "$1" + s);
    var y = a ? e.getUTCMilliseconds() : e.getMilliseconds();
    r = r.replace(/(^|[^\\])fff+/g, "$1" + t(y, 3)), y = Math.round(y / 10), r = r.replace(/(^|[^\\])ff/g, "$1" + t(y)), y = Math.round(y / 10), r = r.replace(/(^|[^\\])f/g, "$1" + y);
    var f = 12 > M ? "AM" : "PM";
    r = r.replace(/(^|[^\\])TT+/g, "$1" + f), r = r.replace(/(^|[^\\])T/g, "$1" + f.charAt(0));
    var h = f.toLowerCase();
    r = r.replace(/(^|[^\\])tt+/g, "$1" + h), r = r.replace(/(^|[^\\])t/g, "$1" + h.charAt(0));
    ...
    return r = r.replace(new RegExp(l[0], "g"), l[C]), r = r.replace(new RegExp(p[0], "g"), p[C]), r = r.replace(new RegExp(g[0], "g"), g[u]), r = r.replace(new RegExp(c[0], "g"), c[u]), r = r.replace(/\\(.)/g, "$1")
}
Date.prototype.format = function(e, r) {
    return formatDate(this, e, r)
};
...
! function(t) {
    function e(e, n) {
        this.element = e, this.settings = t.extend({}, s, n), this._defaults = s, this._name = i, this.version = "v1.0.0", this.$element = t(this.element), this.$wrapper = this.$element.parent(), this.$items = this.$element.children(this.settings.itemSelecter), this.next = 0, this.timeoutHandle, this.intervalHandle, this.settings.enable && this.init()
    }
    var i = "eventslider",
        s = {
            enable: !0,
    ...
    e.prototype = {
        init: function() {
            var e = this,
                i = 0;
            t.each(this.$items, function(s, n) {
                i += parseInt(e.isHorizontal() ? t(n).outerWidth() : t(n).outerHeight())
            });
            var s = this.isHorizontal() ? this.$element.outerWidth : this.$element.outerHeight;
            s > i || (this.$wrapper.css({
                position: "relative",
                overflow: "hidden"
            }), this.$element.css({
                position: "absolute",
        ...
        play: function(e) {
            this.clearTimeout();
            for (var i = 0, s = 0; s <= this.next; s++) i -= parseInt(this.isHorizontal() ? t(this.$items.get(this.next)).outerWidth() : t(this.$items.get(this.next)).outerHeight());
            this.intervalHandle = setInterval(function() {
                e.animate(i)
            }, this.settings.timing)
        },
        animate: function(t) {
            var e = this.isHorizontal() ? "left" : "top",
                i = parseInt(this.$element.css(e));
            i > t ? i - this.settings.speed <= t ? this.$element.css(e, t) : this.$element.css(e, i - this.settings.speed) : (this.clearInterval(), this.next + 1 < this.$items.length ? this.next++ : (this.next = 0, this.$element.css(e, 0)), this.timer(this))
        },
        ...
        addHoverEvent: function(t) {
            this.$wrapper.mouseenter(function() {
                t.clearInterval(), t.clearTimeout()
            }).mouseleave(function() {
                t.play(t)
            })
        }
...
! function(e) {
    ...
    var t, n, o, i, r, a, s = "Close",
        ...
        E = function() {
            e.eventpopup.instance || (t = new y, t.init(), e.eventpopup.instance = t)
        },
        _ = function() {
    ...
    y.prototype = {
        ...
        open: function(n) {
            ...
            var l = e.eventpopup.modules;
            for (i = 0; i < l.length; i++) {
                var c = l[i];
                c = c.charAt(0).toUpperCase() + c.slice(1), t["init" + c].call(t)
            }
            k("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (I(p, function(e, t, n, o) {
            ...
            }, 16), t.isOpen = !0, t.updateSize(d), k(u), n
        },
        close: function() {
        ...
        updateItemHTML: function() {
            ...
            if (k("BeforeChange", [t.currItem ? t.currItem.type : "", o]), t.currItem = n, !t.currTemplate[o]) {
                ...
                k("FirstMarkupParse", r), t.currTemplate[o] = r ? e(r) : !0
            }
            i && i !== n.type && t.container.removeClass("mfp-" + i + "-holder");
            var a = t["get" + o.charAt(0).toUpperCase() + o.slice(1)](n, t.currTemplate[o]);
            t.appendContent(a, o), n.preloaded = !0, k(f, n), i = n.type, t.container.prepend(t.contentContainer), k("AfterChange")
        },
        ...
        _openClick: function(n, o, i) {
            var r = void 0 !== i.midClick ? i.midClick : e.eventpopup.defaults.midClick;
            if (r || 2 !== n.which && !n.ctrlKey && !n.metaKey) {
                var a = void 0 !== i.disableOn ? i.disableOn : e.eventpopup.defaults.disableOn;
                if (a)
                    if (e.isFunction(a)) {
        ...
        _parseMarkup: function(t, n, o) {
            var i;
            o.data && (n = e.extend(o.data, n)), k(p, [t, n, o]), e.each(n, function(e, n) {
        ...
        close: function() {
            return e.eventpopup.instance && e.eventpopup.instance.close()
        },
        registerModule: function(t, n) {
            n.options && (e.eventpopup.defaults[t] = n.options), e.extend(this.proto, n.proto), this.modules.push(t)
        },
        defaults: {
            disableOn: 0,
            key: null,
    ...
    }, e.fn.eventpopup = function(n) {
        E();
        var o = e(this);
        if ("string" == typeof n)
            if ("open" === n) {
                var i, r = w ? o.data("eventpopup") : o[0].eventpopup,
                    a = parseInt(arguments[1], 10) || 0;
                r.items ? i = r.items[a] : (i = o, r.delegate && (i = i.find(r.delegate)), i = i.eq(a)), t._openClick({
                    mfpEl: i
                }, o, r)
            } else t.isOpen && t[n].apply(t, Array.prototype.slice.call(arguments, 1));
        else n = e.extend(!0, {}, n), w ? o.data("eventpopup", n) : o[0].eventpopup = n, t.addGroup(o, n);
        return o
    };
    var S, O, z, M = "inline",
        B = function() {
            ...
            getInline: function(n, o) {
                if (B(), n.src) {
                    ...
                    if (r.length) {
                        ...
                        a && a.tagName && (O || (S = i.hiddenClass, O = x(S), S = "mfp-" + S), z = r.after(O).detach().removeClass(S)), t.updateStatus("ready")
    ...
    e.eventpopup.registerModule(F, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(F), P = t.st.ajax.cursor, I(s + "." + F, L), I("BeforeChange." + F, L)
            },
            getAjax: function(n) {
    ...
    e.eventpopup.registerModule("image", {
        options: {
        ...
        proto: {
            initImage: function() {
                var n = t.st.image,
                    o = ".image";
                t.types.push("image"), I(u + o, function() {
            ...
            getImage: function(n, o) {
                var i = 0,
                    r = function() {
                        n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, k("ImageLoadComplete")) : (i++, 200 > i ? setTimeout(r, 100) : a()))
                    },
                    a = function() {
                ...
                }, n), t.resizeImage(), n.hasSize ? (A && clearInterval(A), n.loadError ? (o.addClass("mfp-loading"), t.updateStatus("error", s.tError.replace("%url%", n.src))) : (o.removeClass("mfp-loading"), t.updateStatus("ready")), o) : (t.updateStatus("loading"), n.loading = !0, n.hasSize || (n.imgHidden = !0, o.addClass("mfp-loading"), t.findImageSize(n)), o)
            }
        }
    });
    var N, W = function() {
    ...
    e.eventpopup.registerModule("zoom", {
        options: {
            enabled: !1,
            easing: "ease-in-out",
            duration: 300,
    ...
    e.eventpopup.registerModule("gallery", {
        options: {
            enabled: !1,
        ...
        proto: {
            initGallery: function() {
                ...
                return t.direction = !0, n && n.enabled ? (r += " mfp-gallery", I(u + i, function() {
                    n.navigateByImgClick && t.wrap.on("click" + i, ".mfp-img", function() {
                        return t.items.length > 1 ? (t.next(), !1) : void 0
                    }), o.on("keydown" + i, function(e) {
                        37 === e.keyCode ? t.prev() : 39 === e.keyCode && t.next()
                    })
                }), I("UpdateStatus" + i, function(e, n) {
                    n.text && (n.text = K(n.text, t.currItem.index, t.items.length))
                }), I(p + i, function(e, o, i, r) {
                    var a = t.items.length;
                    i.counter = a > 1 ? K(n.tCounter, r.index, a) : ""
                }), I("BuildControls" + i, function() {
                    if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                        var o = n.arrowMarkup,
                            i = t.arrowLeft = e(o.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(C),
                            r = t.arrowRight = e(o.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(C),
                            s = a ? "mfpFastClick" : "click";
                        i[s](function() {
                            t.prev()
                        }), r[s](function() {
                            t.next()
                        }), t.isIE7 && (x("b", i[0], !1, !0), x("a", i[0], !1, !0), x("b", r[0], !1, !0), x("a", r[0], !1, !0)), t.container.append(i.add(r))
                    }
                }), I(f + i, function() {
                    ...
                    o.off(i), t.wrap.off("click" + i), t.arrowLeft && a && t.arrowLeft.add(t.arrowRight).destroyMfpFastClick(), t.arrowRight = t.arrowLeft = null
                })) : !1
            },
            next: function() {
            ...
            _preloadItem: function(n) {
                if (n = D(n), !t.items[n].preloaded) {
                    var o = t.items[n];
                    o.parsed || (o = t.parseEl(n)), k("LazyLoad", o), "image" === o.type && (o.img = e('<img class="mfp-img" />').on("load.mfploader", function() {
                        o.hasSize = !0
                ...
                return e(this).each(function() {
                    ...
                    if (n) {
                        ...
                        s.on("touchstart" + r, function(e) {
                            p = !1, f = 1, u = e.originalEvent ? e.originalEvent.touches[0] : e.touches[0], c = u.clientX, d = u.clientY, b.on("touchmove" + r, function(e) {
                                u = e.originalEvent ? e.originalEvent.touches : e.touches, f = u.length, u = u[0], (Math.abs(u.clientX - c) > 10 || Math.abs(u.clientY - d) > 10) && (p = !0, o())
                            }).on("touchend" + r, function(e) {
                                o(), p || f > 1 || (a = !0, e.preventDefault(), clearTimeout(l), l = setTimeout(function() {
                                    a = !1
                                }, t), i())
                            })
                        })
